...
export function AssistantHeader({ onNavigate }: ScreenProps) {
  return <ContentWidth maxWidth={808}><View className="flex-row items-center gap-2 pt-2"><IconButton icon="back" label="Back to home" onPress={() => onNavigate('home')}/><Label className="text-[13px] text-home-muted">Ask {HOME_NAME}</Label></View></ContentWidth>;
}
