import { Icon, Label, Pill, SectionTitle, colors } from '@willo/ui';
...
export function ActivityScreen({ onNavigate }: ScreenProps) {
  ...
  return <View className="flex-1 bg-white"><AskHeader onNavigate={onNavigate}/><PageScroll>
...
export function TimelineScreen({ onNavigate }: ScreenProps) {
  ...
  return <View className="flex-1 bg-white"><ClassicHeader title="Activity" onNavigate={onNavigate} filter={openFilter}/><PageScroll maxWidth={1200}>
