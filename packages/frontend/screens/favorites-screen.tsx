...
export function FavoritesScreen({ onNavigate, withAssistant = false, header }: ScreenProps & { withAssistant?: boolean }) {
  ...
  const cards: DashboardCard[] = [
    ...
    { id: 'yard', span: compact ? 2 : 1, estimatedHeight: compact ? 196 : 284, content: <CameraCard garden showBadge={false} height={compact ? 196 : 284} label={withAssistant ? 'Backyard camera' : 'Yard cam'}/> },
